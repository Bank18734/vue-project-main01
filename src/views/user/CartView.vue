...
<template>
  <UserLayout>
    ...
    <div class="flex ">
            ...
            <div class="flex flex-col justify-between h-full">
              <div>
                <div class="relative grid grid-cols-2">
                  ...
                  <div>
                    <select v-model="item.quantity" @change="changeQuantity($event, index)" class="block w-1/2 p-2 mb-6 text-sm ml-[65px] text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      ...
      <div class="flex-auto w-32 h-full bg-slate-300 p-4 border-l-black border-2">
